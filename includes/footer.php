	...
	<footer class="site-footer">
		<div class="footer-main">
			...
			<div class="footer-section footer-services">
				...
				<?php
				$footerServices = $conn->query("SELECT title, slug FROM treatments WHERE status='active' ORDER BY created_at DESC LIMIT 6");
				if ($footerServices && $footerServices->num_rows > 0):
					while ($svc = $footerServices->fetch_assoc()):
				?>
					<a href="services/<?php echo urlencode($svc['slug'] ?? ''); ?>">
	...
	<a href="tel:+919634430627" class="sticky-contact-btn sticky-call-btn" title="Call Now" style="z-index:10001;">
		<i class="bi bi-telephone-fill"></i>
	</a>
	<a href="https://wa.me/9634430627" target="_blank" class="sticky-contact-btn sticky-whatsapp-btn" title="WhatsApp" style="z-index:10000;">
