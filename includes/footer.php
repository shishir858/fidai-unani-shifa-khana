            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="footer-widget-contact">
                ...
                <ul class="contact-list list-unstyled">
                  ...
                  <li>
                    <a href="tel:9634430627" class="phone__number">
                      <i class="icon-phone"></i> <span>9634430627 / 9568304355</span>
                    </a>
                  </li>
                  <li class="color-body">Rawli Road Chungi no.3
Near by Police Chauki
Muradagar, Ghaziabad
Uttar Pradesh 201206</li>
                </ul>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-6 col-lg-6">
              ...
              <a class="fz-14 color-primary" href="https://sspsoftproindia.com/">SSP Shoftpro India</a>
            </div><!-- /.col-lg-6 -->
            <div class="col-sm-12 col-md-6 col-lg-6">
              <nav>
