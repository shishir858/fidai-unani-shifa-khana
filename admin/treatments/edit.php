...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $short_description = mysqli_real_escape_string($conn, trim(sanitize_treatment_editor_html($_POST['short_description'])));
    $full_description = mysqli_real_escape_string($conn, trim(sanitize_treatment_editor_html($_POST['full_description'])));
        ...
        <div class="admin-card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="short_description" id="short_description" class="form-control treatment-summernote" rows="4"><?php echo treatment_editor_textarea_value($treatment['short_description'] ?? ''); ?></textarea>
                    <small class="text-muted">Headings, lists, links, images (uploads save under assets/images/treatments/editor/).</small>
                </div>
                <div class="mb-3" style="margin-top: 90px;">
                    <label class="form-label">Full Description</label>
                    <textarea name="full_description" id="full_description" class="form-control treatment-summernote" rows="8"><?php echo treatment_editor_textarea_value($treatment['full_description'] ?? ''); ?></textarea>
                </div>
            </div>
        </div>
        <div class="admin-card mb-4">
