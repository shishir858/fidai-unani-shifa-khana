...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $short_description = isset($_POST['short_description']) ? mysqli_real_escape_string($conn, trim($_POST['short_description'])) : '';
    $full_description = isset($_POST['full_description']) ? mysqli_real_escape_string($conn, trim($_POST['full_description'])) : '';
