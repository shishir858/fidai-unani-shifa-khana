         ...
         <div class="item">
            <div class="treatment-card-creative animate__animated animate__fadeInUp">
               ...
               <div class="treatment-card-body-creative text-center p-3" style="background:rgba(255,255,255,0.92);border-radius:0 0 1.5em 1.5em;box-shadow:0 2px 12px #1c430722;">
                  ...
                  <a href="services/<?php echo urlencode($treat['slug'] ?? ''); ?>" class="btn btn-outline-success btn-sm mt-2" style="border-radius:2em;font-weight:700;">Learn More</a>
               </div>
            </div>
         </div>
         <?php endwhile; endif; ?>
               ...
               <div class="col-md-6">
                  <div class="card h-100 border-0 shadow-sm">
                     <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-1" style="color:#1c4307;font-weight:700;text-transform: unset!important;">
   ...
   <div class="container">
      ...
      <div class="row g-3 justify-content-center">
         <?php
            ...
            ?>
         <div class="col-lg-2 col-md-3 col-sm-4 col-6 d-flex align-items-center justify-content-center mb-3">
            <img src="<?php echo $img['image']; ?>" alt="Gallery" style="width:100%;height:160px;object-fit:contain;display:block;background:#fff;">
         </div>
         <?php endwhile; endif; ?>
      </div>
   </div>
   ...
   <div class="container">
      <div class="row align-items-center">
         <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="assets/images/about/3.png" alt="Our Story" class="our-story-img-responsive" style="height:320px;width:100%;max-width:100%;border-radius:18px;box-shadow:0 8px 32px #bab9b9;object-fit:cover;">
         </div>
         <div class="col-lg-6">
      ...
      <div class="row align-items-center justify-content-center">
         <div class="col-lg-6 mb-4 mb-lg-0 animate__animated animate__fadeInLeft">
            ...
            <div class="mt-5 d-none d-lg-block" style="max-width:340px;">
               <img src="assets/images/about/doctor-illustration.jpeg" alt="Doctor Illustration" style="width:100%;filter:drop-shadow(0 8px 32px #bab9b9);animation:floatY 3.5s ease-in-out infinite;">
            </div>
         </div>
